...
import Landing from "../@onboarding/components/landing/landing";
import About from "../@onboarding/components/landing/about-c2c";
import Sponsors from "../@onboarding/components/landing/sponsors";
import FAQs from "../@onboarding/components/landing/faqs";
import Timeline from "../@onboarding/components/landing/timeline";
import AboutACM from "../@onboarding/components/landing/about-acm";
import Statistics from "../@onboarding/components/landing/statistics";
import Footer from "../@onboarding/components/landing/footer";
import Speaker from "../@onboarding/components/landing/speaker";
import ViewportPortal from "@/components/viewport-portal";
import { useLayoutEffect } from "react";
import { InteractiveHoverButton } from "../@onboarding/components/landing/ui/cta-button";
import { StickyScroll } from "../@onboarding/components/landing/ui/sticky-scroll-reveal";
import Image from "next/image";
import GradientBG from "../@onboarding/components/landing/gradient-bg";
import DotGrid from "../@onboarding/components/landing/dot-grid";
import HeadingText from "../@onboarding/components/landing/HeadingText";
import Tracks from "../@onboarding/components/landing/tracks";
