    ...
    <div className={cn("relative w-full min-h-screen bg-black", className)}>
      ...
      <div className="absolute top-0 left-0 w-full h-[400px] z-10 pointer-events-none overflow-hidden">
        <div className="relative w-full scale-250 flex items-center justify-center">
          ...
          >
            <div className="absolute w-[100%] h-full left-0 bg-transparent bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
            <div className="absolute w-40 left-0 bg-transparent h-full bottom-0 z-20 [mask-image:linear-gradient(to_right,white,transparent)]" />
          </div>
...
// Lightweight overlay-only version for embedding into pages that already
// manage their own background. Renders just the lamp highlight at the top.
export function LampOverlay() {
  return (
    <div className="pointer-events-none absolute top-0 left-0 w-full h-[400px] z-10 overflow-hidden">
      <div className="relative w-full scale-250 flex items-center justify-center">
        <div
          style={{
            backgroundImage: `conic-gradient(var(--conic-position), var(--tw-gradient-stops))`,
