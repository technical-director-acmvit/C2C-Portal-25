    ...
    <GradientBG>
        <div id="about" className="w-full h-[600px] relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center justify-center pointer-events-none">
                <div className="w-[994px] max-w-[calc(100%-2rem)] text-justify justify-start text-zinc-100 text-3xl font-normal leading-10 pointer-events-auto" style={{ fontFamily: 'DM Sans, Arial, sans-serif' }}>
