  ...
  return (
    <div className="fixed inset-0 w-screen h-screen relative overflow-hidden">
      ...
      <div className="flex items-center justify-center min-h-full px-4 py-6 sm:py-8 relative z-10 overflow-auto">
        <div className="w-full max-w-[22rem] sm:max-w-md md:max-w-lg lg:max-w-xl p-5 sm:p-6 md:p-8 rounded-2xl" style={{
          ...
          <div className="mb-4 sm:mb-5">
            <input
              ...
              style={{ fontFamily: "'Pilat Extended', Arial, sans-serif", fontSize: 'clamp(14px, 4.2vw, 16px)', fontWeight: 400 }}
            />
          </div>

          <p className="text-gray-400 text-center mb-5 sm:mb-6" style={{ fontSize: 'clamp(12px, 3.8vw, 14px)', fontFamily: "'Pilat Regular', Arial, sans-serif", fontWeight: 400 }}>
            The coolest team names get brownie points!
          </p>

          <div className="flex justify-center">
            <PortalButton onClick={handleProceed} disabled={!teamName.trim() || loading} className={`${teamName.trim() ? '' : 'opacity-50 cursor-not-allowed'} w-full sm:w-auto px-5 sm:px-6 py-3 text-[clamp(15px,4.4vw,18px)]`}>
